# CreateGroup {#doc_api_977722 .reference}

创建用户组。

## 调试 {#apiExplorer .section}

前往【[API Explorer](https://api.aliyun.com/#product=Ram&api=CreateGroup)】在线调试，API Explorer 提供在线调用 API、动态生成 SDK Example 代码和快速检索接口等能力，能显著降低使用云 API 的难度，强烈推荐使用。
...
|Action|String|是|CreateGroup|系统规定参数。取值：CreateGroup
 ...
 |
|GroupName|String|是|Dev-Team|组名称，最大长度64个字符。
